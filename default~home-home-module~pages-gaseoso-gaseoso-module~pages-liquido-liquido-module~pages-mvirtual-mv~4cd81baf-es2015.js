...
let ServicioService = class ServicioService {
    constructor(bs, auth, sanitizer, db, storage) {
        this.bs = bs;
        this.auth = auth;
    ...
    loginGoogle() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            var aux, aux1, verif;
            try {
                var provider = new firebase_app__WEBPACK_IMPORTED_MODULE_3__["default"].auth.GoogleAuthProvider();
                provider.addScope('profile');
                provider.addScope('email');
                yield (firebase_app__WEBPACK_IMPORTED_MODULE_3__["default"].auth().signInWithPopup(provider).then(function (result) {
    ...
    GetItem() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            let aux;
            const value = yield Storage.get({ key: 'pdf2' }).then(res => {
    ...
    GetImage() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            let aux;
            const value = yield Storage.get({ key: 'image' }).then(res => {
                aux = JSON.parse(res.value);
            });
            return aux;
        });
    ...
    consultar(nuevopdf) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const promise = yield new Promise((resolve) => {
                const Bs = this.feriacolletion.doc(nuevopdf.id).collection(nuevopdf.id).get().toPromise().then(resp => {
                    a = resp.docs;
                }).then(() => {
                    resolve(a);
                });
    ...
    localFirebase(id, num) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const Bs = yield this.feriacolletion.doc(id).collection(id).doc(num.toString()).get().toPromise().then(res => {
                let a = res.data();
                this.AddItem(a);
            });
        });
    }
    consultarid(nuevopdf) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const Bs = yield this.feriacolletion.doc(nuevopdf.id).collection(nuevopdf.id).snapshotChanges();
            return Bs;
        });
    }
    addNewToGallery() {
...
//# sourceMappingURL=default~home-home-module~pages-gaseoso-gaseoso-module~pages-liquido-liquido-module~pages-mvirtual-mv~4cd81baf-es2015.js.map