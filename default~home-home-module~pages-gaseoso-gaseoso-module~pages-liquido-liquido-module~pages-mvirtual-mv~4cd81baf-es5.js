(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~home-home-module~pages-gaseoso-gaseoso-module~pages-liquido-liquido-module~pages-mvirtual-mv~4cd81baf"], {
    /***/
    ...
    function srcAppServicesServicioServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var ServicioService = /*#__PURE__*/function () {
        function ServicioService(bs, auth, sanitizer, db, storage) {
          ...
          this.nombre = '';
          this.email = '';
          this.feriacolletion = this.bs.collection('BangPro');
        }
        ...
        _createClass(ServicioService, [{
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      _context.next = 6;
                      return firebase_app__WEBPACK_IMPORTED_MODULE_3__["default"].auth().signInWithPopup(provider).then(function (result) {
          ...
          value: function addItem(newitem) {
            localStorage.setItem('pdf', JSON.stringify(newitem));
          }
        }, {
          key: "getItem",
          value: function getItem(nombre) {
          ...
          key: "AddImage",
          value: function AddImage(newitem) {
            Storage.set({
              key: 'image',
              value: JSON.stringify(newitem)
            });
                  ...
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      ...
                      return Storage.get({
                        ...
                        aux = JSON.parse(res.value);
                      });

                    case 2:
                      value = _context2.sent;
                      return _context2.abrupt("return", aux);
                ...
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    ...
                    case 2:
                      ...
                      return _context3.abrupt("return", aux);
          ...
          key: "removeItem",
          value: function removeItem(pdf) {
            localStorage.remove(pdf);
          }
        }, {
          key: "subir",
          value: function subir(nuevopdf) {
            this.feriacolletion.doc(nuevopdf.id).set(nuevopdf);
          }
        }, {
          key: "subir2",
          value: function subir2(nuevopdf) {
            this.feriacolletion.doc(nuevopdf.id).collection(nuevopdf.id).doc(nuevopdf.num.toString()).set(nuevopdf);
          }
        }, {
          key: "editar",
          value: function editar(id, pdf) {
            var Bs = this.feriacolletion.doc(id);
            return Bs.update(pdf);
          }
        }, {
          key: "editar2",
          value: function editar2(id, pdf, num) {
            var Bs = this.feriacolletion.doc(id).collection(id).doc(num.toString());
            return Bs.update(pdf);
          }
        }, {
          key: "eliminar",
          value: function eliminar(id, num) {
            var Bs = this.feriacolletion.doc(id).collection(id).doc(num.toString())["delete"]();
          }
        }, {
          key: "consultar",
          value: function consultar(nuevopdf) {
                ...
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    case 0:
                      ...
                      _context4.next = 4;
                      return new Promise(function (resolve) {
                        var Bs = _this2.feriacolletion.doc(nuevopdf.id).collection(nuevopdf.id).get().toPromise().then(function (resp) {
                          a = resp.docs;
                        }).then(function () {
                          resolve(a);
                        });
          ...
          key: "localFirebase",
          value: function localFirebase(id, num) {
              ...
              return regeneratorRuntime.wrap(function _callee5$(_context5) {
                while (1) {
                  switch (_context5.prev = _context5.next) {
                    case 0:
                      _context5.next = 2;
                      return this.feriacolletion.doc(id).collection(id).doc(num.toString()).get().toPromise().then(function (res) {
                        var a = res.data();
          ...
          key: "consultarid",
          value: function consultarid(nuevopdf) {
              ...
              return regeneratorRuntime.wrap(function _callee6$(_context6) {
                while (1) {
                  switch (_context6.prev = _context6.next) {
                    case 0:
                      _context6.next = 2;
                      return this.feriacolletion.doc(nuevopdf.id).collection(nuevopdf.id).snapshotChanges();

                    case 2:
                      Bs = _context6.sent;
                      return _context6.abrupt("return", Bs);
                ...
                while (1) {
                  switch (_context7.prev = _context7.next) {
                    ...
                    case 2:
                      ...
                      return _context7.abrupt("return", capturedPhoto);
...
//# sourceMappingURL=default~home-home-module~pages-gaseoso-gaseoso-module~pages-liquido-liquido-module~pages-mvirtual-mv~4cd81baf-es5.js.map