...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SolidoPageRoutingModule", function() { return SolidoPageRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _solido_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./solido.page */ "./src/app/pages/solido/solido.page.ts");
...
let SolidoPageRoutingModule = class SolidoPageRoutingModule {
};
SolidoPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SolidoPageModule", function() { return SolidoPageModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js");
/* harmony import */ var _solido_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./solido-routing.module */ "./src/app/pages/solido/solido-routing.module.ts");
/* harmony import */ var _solido_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./solido.page */ "./src/app/pages/solido/solido.page.ts");
...
let SolidoPageModule = class SolidoPageModule {
};
SolidoPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"],
            _solido_routing_module__WEBPACK_IMPORTED_MODULE_5__["SolidoPageRoutingModule"]
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SolidoPage", function() { return SolidoPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
/* harmony import */ var _assets_json_factores_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./../../../assets/json/factores.json */ "./src/assets/json/factores.json");
var _assets_json_factores_json__WEBPACK_IMPORTED_MODULE_4___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./../../../assets/json/factores.json */ "./src/assets/json/factores.json", 1);





let SolidoPage = class SolidoPage {
    ...
    selectorfactores() {
        let a = this.personajeSeleccionadoaux.toLowerCase();
        switch (a) {
            case 'crispi':
    ...
    ngAfterViewInit() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            this.route.params.subscribe(params => {
                ...
                const _personaje = params.personajeSeleccionado;
                this.personajeSeleccionado = _personaje;
    ...
    personajesMode(forma) {
        this.personajesModeR = `FONDO-${forma}`;
    }
    personajeRandom() {
    ...
    selecionador(item) {
        this.mipromesa().finally(() => {
            const DEFAULT_SELECT = '';
            const NUM_SELECT = {
                0: this.personajesArr[0],
                1: this.personajesArr[2],
                2: this.personajesArr[1],
                3: this.personajesArr[3],
                4: this.personajesArr[4]
            };
            const number = NUM_SELECT[item] || DEFAULT_SELECT;
            this.personajeSeleccionadoaux = number.toUpperCase();
            this.pdf.personaje = this.personajeSeleccionadoaux;
        });
    }
    guardarpersonaje() {
    ...
    factores() {
        ...
        const number = OP_SELECT[this.pasoSelecionado] || DEFAULT_SELECT;
        this.pasoSelecionado = number;
        this.mipromesa().finally(() => {
            this.pdf.factor = number;
            this.pdf.solido = 'Iniciado';
            this.pdf.personaje = this.personajeSeleccionadoaux;
    ...
    saveInputPaso1() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield this.mipromesa().then(() => {
                this.pdf.P1 = this.Paso1;
                this.serv.AddItem(this.pdf);
            });
        });
    }
    ...
    saveInputPaso3() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield this.mipromesa().then(() => {
                this.pdf.P3_1 = this.Paso3_1;
                this.pdf.P3_2 = this.Paso3_2;
                this.pdf.P3_3 = this.Paso3_3;
                this.pdf.P3_4 = this.Paso3_4;
                this.serv.AddItem(this.pdf);
                this.serv.subir2(this.pdf);
            });
        });
    }
    openPopUP(item) {
    ...
    promesafactor() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            new Promise((resolve) => {
                if (this.objaux.num != "") {
                    this.pdf = this.objaux;
                    this.pasoSelecionado = this.pdf.factor;
                    return resolve(this.pdf);
                }
            });
        });
...
SolidoPage.ctorParameters = () => [
    { type: _services_servicio_service__WEBPACK_IMPORTED_MODULE_2__["ServicioService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }
];
SolidoPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-solido',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./solido.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/solido/solido.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./solido.page.scss */ "./src/app/pages/solido/solido.page.scss")).default]
    })
], SolidoPage);
...
//# sourceMappingURL=pages-solido-solido-module-es2015.js.map