(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-mvirtual-mvirtual-module"], {
    ...
    /***/
    function node_modulesDomToImageImprovedSrcDomToImageImprovedJs(module, exports, __webpack_require__) {
      (function (global) {
        'use strict';
        ...
        function draw(domNode, options) {
          return toSvg(domNode, options).then(util.makeImage).then(util.delay(100)).then(function (image) {
            ...
            if (image) {
              ...
              ctx.scale(scale, scale); //canvas.height = 620;
              ...
              if (options.canvas) {
                ...
                ctx.drawImage(image, options.canvas.sx || 0, options.canvas.sy || 0, options.canvas.sw || options.width, options.canvas.sh || options.height, options.canvas.dx || 0, options.canvas.dy || 0, options.canvas.dw || options.width, options.canvas.dh || options.height);
              } else {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppPagesMvirtualMvirtualPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPagesMvirtualMvirtualRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "MvirtualPageRoutingModule", function () {
        return MvirtualPageRoutingModule;
      });
      /* harmony import */
      ...
      var _mvirtual_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./mvirtual.page */
      ...
      var MvirtualPageRoutingModule = function MvirtualPageRoutingModule() {
        _classCallCheck(this, MvirtualPageRoutingModule);
      };

      MvirtualPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function srcAppPagesMvirtualMvirtualModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "MvirtualPageModule", function () {
        return MvirtualPageModule;
      });
      /* harmony import */
      ...
      var _mvirtual_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./mvirtual-routing.module */
      "./src/app/pages/mvirtual/mvirtual-routing.module.ts");
      /* harmony import */


      var _mvirtual_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./mvirtual.page */
      "./src/app/pages/mvirtual/mvirtual.page.ts");

      var MvirtualPageModule = function MvirtualPageModule() {
        _classCallCheck(this, MvirtualPageModule);
      };

      MvirtualPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _mvirtual_routing_module__WEBPACK_IMPORTED_MODULE_5__["MvirtualPageRoutingModule"]],
    ...
    /***/
    function srcAppPagesMvirtualMvirtualPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPagesMvirtualMvirtualPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "MvirtualPage", function () {
        return MvirtualPage;
      });
      /* harmony import */
      ...
      var dom_to_image_improved__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! dom-to-image-improved */
      "./node_modules/dom-to-image-improved/src/dom-to-image-improved.js");
      /* harmony import */


      var dom_to_image_improved__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(dom_to_image_improved__WEBPACK_IMPORTED_MODULE_4__);
      /* harmony import */


      var src_app_services_servicio_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! src/app/services/servicio.service */
      "./src/app/services/servicio.service.ts");

      var MvirtualPage = /*#__PURE__*/function () {
        function MvirtualPage(serv, plt, router) {
          _classCallCheck(this, MvirtualPage);
        ...
        _createClass(MvirtualPage, [{
          key: "navegar",
          value: function navegar(ruta) {
          ...
          value: function Guardar() {
            ...
            var w = document.getElementById("imageCanvas").style.width;
            var h = document.getElementById("imageCanvas").style.height;
            dom_to_image_improved__WEBPACK_IMPORTED_MODULE_4___default.a.toPng(document.getElementById("imageCanvas"), {
              width: this.canvasElement.widt,
              ...
              if (canvas) {
                ...
                _this.serv.AddItem(_this.pdf);

                _this.serv.addItem(_this.pdf);

                _this.serv.editar2(_this.pdf.id, _this.pdf, _this.pdf.num);
              }
          ...
          key: "ChangeTool",
          value: function ChangeTool(toolClicked) {
          ...
          key: "MousePosition",
          value: function MousePosition(ev) {
            var currentX;
            var currentY; // Get canvas size and position in web page

            var canvasSizeData = this.canvasElement.getBoundingClientRect();
          ...
          key: "RedrawCanvasImage",
          value: function RedrawCanvasImage() {
            // Restore image
          ...
          value: function getPolygon() {
            ...
            for (var i = 1; i < this.polygonSides; i++) {
          ...
          key: "getAngleUsingXAndY",
          value: function getAngleUsingXAndY(mouselocX, mouselocY) {
            var adjacent = this.mousedown.x - mouselocX;
            var opposite = this.mousedown.y - mouselocY;
          ...
          value: function getPolygonPoints() {
            ...
            var angle = this.degreesToRadians(this.getAngleUsingXAndY(this.loc.x, this.loc.y)); // X & Y for the X & Y point representing the radius is equal to
            // the X & Y of the bounding rubberband box

            var radiusX = this.shapeBoundingBox.width;
            var radiusY = this.shapeBoundingBox.height; // Stores all points in the polygon

            var polygonPoints = []; // Each point in the polygon is found by breaking the 
            ...
            for (var i = 0; i < this.polygonSides; i++) {
              polygonPoints.push(new PolygonPoint(this.loc.x + radiusX * Math.sin(angle), this.loc.y - radiusY * Math.cos(angle))); // 2 * PI equals 360 degrees
          ...
          key: "drawRubberbandShape",
          value: function drawRubberbandShape(loc, ev) {
            ...
            if (this.currentTool === "line") {
              ...
              // Create circles
              //this.RedrawCanvasImage();
              var radius = this.shapeBoundingBox.width;
              this.ctx.beginPath();
              ...
              var radiusX = this.shapeBoundingBox.width / 2;
              var radiusY = this.shapeBoundingBox.height / 2;
              this.ctx.beginPath();
          ...
          key: "UpdateRubberbandSizeData",
          value: function UpdateRubberbandSizeData(loc) {
            // Height & width are the difference between were clicked
            // and current mouse position
            this.shapeBoundingBox.width = Math.abs(loc.x - this.mousedown.x);
            this.shapeBoundingBox.height = Math.abs(loc.y - this.mousedown.y); // If mouse is below where mouse was clicked originally
          ...
          key: "UpdateRubberbandOnMove",
          value: function UpdateRubberbandOnMove(loc, ev) {
            // Stores changing height, width, x & y position of most 
            // top left point being either the click or mouse location
            this.UpdateRubberbandSizeData(loc); // Redraw the shape
      ...
      MvirtualPage.ctorParameters = function () {
        return [{
      ...
      MvirtualPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-mvirtual',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./mvirtual.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/mvirtual/mvirtual.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./mvirtual.page.scss */
        "./src/app/pages/mvirtual/mvirtual.page.scss"))["default"]]
      }) // Stores size data used to create rubber band shapes
      // that will redraw as the user moves the mouse
      ], MvirtualPage);

      var PolygonPoint = function PolygonPoint(X, Y) {
        _classCallCheck(this, PolygonPoint);
...
//# sourceMappingURL=pages-mvirtual-mvirtual-module-es5.js.map