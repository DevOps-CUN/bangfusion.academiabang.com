  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
    ...
    function srcAppHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var HomePage = /*#__PURE__*/function () {
        function HomePage(serv, route, router) {
          _classCallCheck(this, HomePage);

          this.serv = serv;
          this.route = route;
          this.router = router; // Funcionalidades
        ...
        _createClass(HomePage, [{
              ...
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      _context2.next = 2;
                      return this.serv.consultarid(pdf);

                    case 2:
                      cantidad = _context2.sent.subscribe(function (res) {
                        if (_this2.pdf.num == "") {
                          _this2.pdf.num = res.length + 1;

                          _this2.serv.AddItem(_this2.pdf);
                        }
                      });
          ...
          key: "getAllIdeas",
          value: function getAllIdeas(pdf) {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
              var _this3 = this;

              var contenedor, ideas;
              return regeneratorRuntime.wrap(function _callee3$(_context3) {
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    case 0:
                      _context3.next = 2;
                      return this.serv.consultar(pdf).then(function (res) {
                        contenedor = res;
                        _this3.contIdeas = contenedor;
                      }).then(function () {
                        _this3.organizador();
                      });

                    case 2:
                      ideas = _context3.sent;
              ...
              return regeneratorRuntime.wrap(function _callee4$(_context4) {
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    case 0:
                      _context4.next = 2;
                      return this.arrBangs[this.contIdeas.length];

                    case 2:
                      a = 0;

                    case 3:
                      if (!(a < this.contIdeas.length)) {
                        _context4.next = 10;
                        break;
                      }

                      _context4.next = 6;
                      return this.contIdeas[a].data().P1;

                    case 6:
                      this.arrBangs[a] = _context4.sent;
              ...
              return regeneratorRuntime.wrap(function _callee5$(_context5) {
                while (1) {
                  switch (_context5.prev = _context5.next) {
                    case 0:
                      _context5.next = 2;
                      return this.contIdeas[n].data();

                    case 2:
                      almacenador = _context5.sent;
          ...
          key: "guardarEliminacion",
          value: function guardarEliminacion(i) {
            this.eliminarV = i;
          }
        }, {
          key: "eliminarN",
          value: function eliminarN() {
          ...
          key: "BangSeleccionado",
          value: function BangSeleccionado(item) {
              ...
              return regeneratorRuntime.wrap(function _callee6$(_context6) {
                while (1) {
                  switch (_context6.prev = _context6.next) {
                    case 0:
                      _context6.next = 2;
                      return this.contIdeas[item].data();

                    case 2:
                      almacenador = _context6.sent;
                      _context6.next = 5;
                      return this.serv.addItem(this.contIdeas[item].data());
              ...
              return regeneratorRuntime.wrap(function _callee7$(_context7) {
                while (1) {
                  switch (_context7.prev = _context7.next) {
                    case 0:
                      this.serv.deleteItem();
                      this.serv.loginGoogle()["finally"](function () {
                        _this4.union();
                      }).then(function () {
                        _this4.pdf.id = _this4.serv.email;
                        _this4.pdf.nombre = _this4.serv.nombre;
                      });
          ...
          key: "goToIdeas",
          value: function goToIdeas() {
            this.router.navigateByUrl('/home/home');
          }
        }, {
          key: "cuantasPersonas",
          value: function cuantasPersonas(personas) {
            console.log(personas);
          }
        }, {
          key: "switchAmbienteImg",
          value: function switchAmbienteImg(ambiente) {
            this.imgAmbiente[ambiente] = this.imgAmbiente[ambiente] == this.imgAmbiente[ambiente].split('-')[0] ? "".concat(this.imgAmbiente[ambiente], "-2") : this.imgAmbiente[ambiente].split('-')[0];
          }
        }, {
          key: "datos",
